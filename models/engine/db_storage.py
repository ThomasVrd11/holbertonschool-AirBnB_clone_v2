#!/usr/bin/python3
""" This module defines a class DBStorage and a class attribute for the storage engine """
...
class DBStorage():
    """This class defines the attributes and methods of DBStorage"""
    __engine = None
    __session = None

    def __init__(self):
        """ i cant bear to write this anymore"""
